'use strict';
// Browser-side DOM helper functions, injected verbatim into the in-app webview
// via executeJavaScript by webview-driver.js. Pure browser code as a string;
// no Node dependencies. Extracted from electron-main.js (byte-identical).
