...
(() => {
  // dashboard/public/activity-timeline/src/index.js
  ...
  function entryMeta(wi) {
    ...
    if (state2 === "New") {
      ...
      if (created && Math.abs(changed - created) < 12e4) return {
        text: "Created",
        color: "var(--blue)",
  ...
  function renderTimelineCharts(items) {
    ...
    for (const wi of items) {
      ...
      if (stateCounts[m.text] !== void 0) stateCounts[m.text]++;
    }
  ...
  function renderTimeline() {
    ...
    for (const wi of items) {
      ...
      else dayKey = d.toLocaleDateString("en-US", {
        weekday: "long",
        month: "short",
        day: "numeric"
      });
        ...
        <div class="timeline-entry" onclick="viewWorkItem(${wi.id})">
          ...
          <div style="flex:1;min-width:0;">
            ...
            <div class="timeline-entry-meta">
              ...
              ${wi.assignedTo ? ` \xB7 ${esc(wi.assignedTo.split("<")[0].trim())}` : ""}
              \xB7 ${time}
              ${wi.type ? ` \xB7 ${wi.type}` : ""}
              ${wi.storyPoints ? ` \xB7 ${wi.storyPoints} pts` : ""}
            </div>
          </div>
        </div>`;
      }
