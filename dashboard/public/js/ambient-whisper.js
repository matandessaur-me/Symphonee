...
(() => {
  ...
  (() => {
    ...
    function _openModal() {
      ...
      bg.querySelector("#awmReview").addEventListener("click", () => {
        close();
        _act();
      });
