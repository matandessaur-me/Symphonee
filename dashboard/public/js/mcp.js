...
(() => {
  // dashboard/public/mcp/src/index.js
  ...
  function renderMcpServerCard(s) {
    ...
    <div style="border:1px solid var(--surface2);border-radius:var(--radius);padding:10px 12px;background:var(--surface0);">
      ...
      <div style="color:var(--subtext0);font-size:10px;margin-top:6px;">${toolCount} tool${toolCount === 1 ? "" : "s"} \xB7 ${resCount} resource${resCount === 1 ? "" : "s"} \xB7 ${prCount} prompt${prCount === 1 ? "" : "s"}${s.error ? ' \xB7 <span style="color:var(--red);">' + escapeHtml(s.error) + "</span>" : ""}</div>
