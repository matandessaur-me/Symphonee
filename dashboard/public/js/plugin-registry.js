...
(() => {
  // dashboard/public/plugin-registry/src/index.js
  ...
  async function savePluginSettings() {
    ...
    inputs.forEach(function(el) {
      ...
      var pid2 = el.dataset.plugin;
      var key = el.dataset.key;
      if (!pid2 || !key) return;
      if (el.classList.contains("plugin-setting-bool") || el.type === "checkbox") {
        if (!byPlugin[pid2]) byPlugin[pid2] = {};
        byPlugin[pid2][key] = !!el.checked;
        return;
      }
      var val = (el.value || "").trim();
      if (!val) return;
      if (!byPlugin[pid2]) byPlugin[pid2] = {};
      byPlugin[pid2][key] = val;
    });
